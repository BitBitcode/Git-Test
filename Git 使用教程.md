...
```
$ cd C:/Github      // 也可以在这个目录下右键菜单选择“Git Bush here”
$ mkdir Git-Test
$ cd Git-Test
$ pwd               // 查看当前路径
/Users/WWC/Git-Test
...
2、初始化本地仓库。确保当前位于仓库文件夹的目录下，在Gitbush中输入：
```
$ git init
Initialized empty Git repository in /Users/wwc/Git-Test/.git/
```
这时，在仓库文件夹中添加了一个名为“.git”的隐藏文件夹。
